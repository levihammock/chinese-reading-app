...
// Paths
const hskCsvPath = path.join(__dirname, 'chinese-reading-app/data/hsk-3.0-word-list.csv');
const cedictPath = path.join(__dirname, 'chinese-reading-app/src/data/cedict-dictionary.ts');
const outputPath = path.join(__dirname, 'chinese-reading-app/src/data/cedict-dictionary-merged.ts');
