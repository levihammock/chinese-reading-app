...
export default function Lesson2Page({ params }: PageProps) {
  ...
  const modules: ModuleCard[] = useMemo(() => [
    {
      ...
      description: 'Learn essential grammar patterns with examples and explanations',
      path: `/lesson/${lessonId}/lesson2/grammar`,
      icon: '1',
      status: 'available'
    },
    {
      ...
      description: 'Practice translating Chinese sentences to English',
      path: `/lesson/${lessonId}/lesson2/quiz`,
      icon: '2',
      status: 'available'
    },
    {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#0081A7] mb-8 text-center">Lesson 2: Grammar</h1>
          <p className="text-[#00AFB9] text-lg text-center mb-12">
            Learn essential grammar patterns through interactive exercises
          </p>
