...
export default function Lesson4Page({ params }: PageProps) {
  ...
  const modules: ModuleCard[] = useMemo(() => [
    {
      ...
      description: 'Practice writing Chinese characters with guided exercises',
      path: `/lesson/${lessonId}/lesson4/writing`,
      icon: '1',
      status: 'available'
    },
    {
      ...
      description: 'Translate English sentences into Chinese characters',
      path: `/lesson/${lessonId}/lesson4/writing`,
      icon: '2',
      status: 'available'
    },
    {
      id: 'writing-quiz',
      title: 'Writing Quiz',
      description: 'Test your character writing skills with interactive questions',
      path: `/lesson/${lessonId}/lesson4/writing`,
      icon: '3',
      status: 'locked'
    }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#0081A7] mb-8 text-center">Lesson 4: Writing</h1>
          <p className="text-[#00AFB9] text-lg text-center mb-12">
            Practice writing Chinese characters and sentences
          </p>
