...
export default function Lesson1Page({ params }: PageProps) {
  ...
  const modules: ModuleCard[] = useMemo(() => [
    {
      ...
      description: 'Learn 10 new vocabulary words with pinyin and English translations',
      path: `/lesson/${lessonId}/lesson1/vocabulary`,
      icon: '1',
      status: 'available'
    },
    {
      ...
      description: 'Match Chinese words with their English translations',
      path: `/lesson/${lessonId}/lesson1/quiz`,
      icon: '2',
      status: 'available'
    },
    {
      ...
      description: 'Test your knowledge with interactive vocabulary questions',
      path: `/lesson/${lessonId}/lesson1/quiz`,
      icon: '3',
      status: 'locked'
    }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-[#0081A7] mb-8 text-center">Lesson 1: Vocabulary</h1>
          <p className="text-[#00AFB9] text-lg text-center mb-12">
            Master essential vocabulary through interactive learning modules
          </p>
